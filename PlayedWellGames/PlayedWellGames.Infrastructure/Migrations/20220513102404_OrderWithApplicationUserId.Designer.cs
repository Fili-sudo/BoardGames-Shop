...
namespace PlayedWellGames.Infrastructure.Migrations
{
    ...
    [Migration("20220513102404_OrderWithApplicationUserId")]
    partial class OrderWithApplicationUserId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlayedWellGames.Core.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PlayedWellGames.Core.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PlayedWellGames.Core.OrderItem", b =>
                {
                    b.HasOne("PlayedWellGames.Core.Order", "Order")
                        .WithMany("OrderItems")
